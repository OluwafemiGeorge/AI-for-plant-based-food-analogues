# -*- coding: utf-8 -*-
"""functionalGrpPlot (3).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1LQFGbmS0131CewoNwNEttRJhepa_hUJx
"""
...
for index, p in enumerate([5, 10, 30, 50]):
    ...
    tsne = TSNE(n_components=2, perplexity =p, random_state = 10, learning_rate=50)
...
# #reading the file
# tsneFile = pd.read_excel('Tsne.xlsx')
# tsneFile["classification_enc"] = enc.fit_transform(tsneFile['colour'])
# labels = tsneFile.colour.unique().tolist()
# tsneFile.drop(['colour'], axis=1, inplace=True)
# features=tsneFile.keys()
# x = tsneFile.loc[:, features].values
# print(tsneFile.head())
# # Separating out the features
...
# for index, p in enumerate([2, 4, 6, 8]):
#     # labels = tsneFile.colour.unique().tolist()
...
#     data_2d=pd.DataFrame(data_2d, columns=['tsne1', 'tsne2'])
#     plt.subplot(2,2,index+1)
#     handles = plt.scatter(data_2d['tsne1'], data_2d['tsne2'], c=tsneFile.classification_enc, cmap=matplotlib.colors.ListedColormap(colors))
#     plt.title('Perplexity = '+ str(p))
#     plt.legend(handles=handles.legend_elements()[0], labels=labels)
